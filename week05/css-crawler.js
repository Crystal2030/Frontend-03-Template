/**
 * 准备工作：
 * 从 https://www.w3.org/TR/?tag=css  网页中抓取css到标准
 */
var standards = [
  {
...
/**
 * 编写思路：
 * 首先创建一个iframe，然后把页面内容替换成iframe
 * 然后循环所有的标准，把标准的url存到iframe的src上
 * 等待iframe的load事件，然后做我们想做的事情：比如爬不同页面不同的内容
 */
...
/**
 * Promise异步函数：等待事件发生一次，如果事件发生了就resolve，resolve之后需要把事件解绑
 * @param {*} element 
 * @param {*} event 
 */
